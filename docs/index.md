...
dumps. Historically those findings lived scattered across notes, chats, and
...
Every protocol fact in the corpus carries:
...
broken down by category and technique. We use it to track progress
