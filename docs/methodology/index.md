...
There is a fixed set of six techniques (the only values allowed in
...
techniques. The [coverage report](../spec/coverage.md) breaks coverage down *by
technique* precisely to surface this imbalance.
