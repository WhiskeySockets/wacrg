...
*before* CELP synthesis (see [mlow-synthesis](../encodings/mlow-synthesis.md)). The generator is
...
[in the full RFC →](../index.md#mlow-noise) · [RFC contents](../index.md#contents)
