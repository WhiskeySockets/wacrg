...
Discovered by Vini - [:material-github: protocol history / diff](https://github.com/WhiskeySockets/wacrg/commits/main/spec/crypto/srtp-master-key.yaml) - [:material-github: blame](https://github.com/WhiskeySockets/wacrg/blame/main/spec/crypto/srtp-master-key.yaml)
...
[Back to the full spec](../../index.md#srtp-master-key)
