...
wacrg is a documentation project: it describes a protocol for interoperability and
research. This policy explains how to handle two different kinds of security matters.
...
Use this path for issues that are about wacrg itself, for example:
...
- Email **security@reforward.dev** (or **rajeh@reforward.dev**).
