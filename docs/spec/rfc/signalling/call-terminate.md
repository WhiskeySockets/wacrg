...
- MUST carry `call-id`, identifying the call being torn down. This is the
  call identifier established in the offer (see [call-offer](../signalling/call-offer.md)), not
  the stanza id.
...
[in the full RFC →](../index.md#call-terminate) · [RFC contents](../index.md#contents)
